\hypertarget{group__hooks}{}\section{Apache Hooks}
\label{group__hooks}\index{Apache Hooks@{Apache Hooks}}
...
\index{Apache Hooks@{Apache Hooks}!S\+T\+A\+R\+T\+\_\+\+P\+R\+E\+Q\+U\+E\+ST@{S\+T\+A\+R\+T\+\_\+\+P\+R\+E\+Q\+U\+E\+ST}}
\index{S\+T\+A\+R\+T\+\_\+\+P\+R\+E\+Q\+U\+E\+ST@{S\+T\+A\+R\+T\+\_\+\+P\+R\+E\+Q\+U\+E\+ST}!Apache Hooks@{Apache Hooks}}
...
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E(int) ap\+\_\+expr\+\_\+exec(request\+\_\+rec $\ast$r}{AP_DECLARE(int) ap_expr_exec(request_rec *r}}]{\setlength{\rightskip}{0pt plus 5cm}A\+P\+\_\+\+D\+E\+C\+L\+A\+RE (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_gaee4b62c3b33a1f9567f36f9fbaaf912a}{}\label{group__hooks_gaee4b62c3b33a1f9567f36f9fbaaf912a}
...
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+\_\+\+D\+E\+C\+L\+A\+RE}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E(void) ap\+\_\+listen\+\_\+pre\+\_\+config(void)}{AP_DECLARE(void) ap_listen_pre_config(void)}}]{\setlength{\rightskip}{0pt plus 5cm}A\+P\+\_\+\+D\+E\+C\+L\+A\+RE (
\begin{DoxyParamCaption}
\item[{{\bf void}}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_ga2991c49e63464ffbc0a6d82f1878f0cd}{}\label{group__hooks_ga2991c49e63464ffbc0a6d82f1878f0cd}
...
1082 \}
\end{DoxyCode}
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+O\+K(apr\+\_\+status\+\_\+t, mpm\+\_\+register\+\_\+timed\+\_\+callback,(apr\+\_\+time\+\_\+t t, ap\+\_\+mpm\+\_\+callback\+\_\+fn\+\_\+t $\ast$cbfn, void $\ast$baton)) A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+O\+K(void}{AP_DECLARE_HOOK(apr_status_t, mpm_register_timed_callback,(apr_time_t t, ap_mpm_callback_fn_t *cbfn, void *baton)) AP_DECLARE_HOOK(void}}]{\setlength{\rightskip}{0pt plus 5cm}A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK (
\begin{DoxyParamCaption}
\item[{{\bf apr\+\_\+status\+\_\+t}}]{, }
\item[{mpm\+\_\+register\+\_\+timed\+\_\+callback}]{, }
\item[{({\bf apr\+\_\+time\+\_\+t} {\bf t}, {\bf ap\+\_\+mpm\+\_\+callback\+\_\+fn\+\_\+t} $\ast${\bf cbfn}, {\bf void} $\ast${\bf baton})}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_ga889d21b2af1aee09b616464013993522}{}\label{group__hooks_ga889d21b2af1aee09b616464013993522}
Notification that connection handling is suspending (disassociating from the current thread) 
\begin{DoxyParams}{Parameters}
{\em c} & The current connection \\
\hline
{\em r} & The current request, or N\+U\+LL if there is no active request\\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
ap\+\_\+hook\+\_\+resume\+\_\+connection 
\end{DoxySeeAlso}
\begin{DoxyNote}{Note}
This hook is not implemented by M\+P\+Ms like Prefork and Worker which handle all processing of a particular connection on the same thread. 
...
Resumption and subsequent suspension of a connection solely to perform I/O by the M\+PM, with no execution of non-\/\+M\+PM code, may not necessarily result in a call to this hook. 
\end{DoxyNote}
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+O\+K(void, resume\+\_\+connection,(conn\+\_\+rec $\ast$c, request\+\_\+rec $\ast$r)) void mpm\+\_\+common\+\_\+pre\+\_\+config(apr\+\_\+pool\+\_\+t $\ast$pconf)}{AP_DECLARE_HOOK(void, resume_connection,(conn_rec *c, request_rec *r)) void mpm_common_pre_config(apr_pool_t *pconf)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf conn\+\_\+rec} {\bf request\+\_\+rec}$\ast$ {\bf r} A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK (
\begin{DoxyParamCaption}
\item[{{\bf void}}]{, }
\item[{resume\+\_\+connection}]{, }
\item[{({\bf conn\+\_\+rec} $\ast${\bf c}, {\bf request\+\_\+rec} $\ast${\bf r})}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_ga5f6df4a8753a79fe2b4810497328cbba}{}\label{group__hooks_ga5f6df4a8753a79fe2b4810497328cbba}
...
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
ap\+\_\+hook\+\_\+suspend\+\_\+connection 
\end{DoxySeeAlso}
\begin{DoxyNote}{Note}
This hook is not implemented by M\+P\+Ms like Prefork and Worker which handle all processing of a particular connection on the same thread. 
...
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+O\+K(int, get\+\_\+mgmt\+\_\+items,(apr\+\_\+pool\+\_\+t $\ast$p, const char $\ast$val, apr\+\_\+hash\+\_\+t $\ast$ht)) A\+P\+R\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+O\+P\+T\+I\+O\+N\+A\+L\+\_\+\+F\+N(void}{AP_DECLARE_HOOK(int, get_mgmt_items,(apr_pool_t *p, const char *val, apr_hash_t *ht)) APR_DECLARE_OPTIONAL_FN(void}}]{\setlength{\rightskip}{0pt plus 5cm}A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{, }
\item[{get\+\_\+mgmt\+\_\+items}]{, }
\item[{({\bf apr\+\_\+pool\+\_\+t} $\ast${\bf p}, const char $\ast${\bf val}, {\bf apr\+\_\+hash\+\_\+t} $\ast${\bf ht})}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_ga546689ba1a2a883d321b4a905ead6246}{}\label{group__hooks_ga546689ba1a2a883d321b4a905ead6246}
This hook provdes a way for modules to provide metrics/statistics about their operational status.


\begin{DoxyParams}{Parameters}
{\em p} & A pool to use to create entries in the hash table \\
\hline
{\em val} & The name of the parameter(s) that is wanted. This is tree-\/structured would be in the form (\textquotesingle{}$\ast$\textquotesingle{} is all the tree, \textquotesingle{}module.$\ast$\textquotesingle{} all of the module , \textquotesingle{}module.\+foo.$\ast$\textquotesingle{}, or \textquotesingle{}module.\+foo.\+bar\textquotesingle{} ) \\
\hline
{\em ht} & The hash table to store the results. Keys are item names, and the values point to \hyperlink{structap__mgmt__item__t}{ap\+\_\+mgmt\+\_\+item\+\_\+t} structures. \\
\hline
\end{DoxyParams}
\index{Apache Hooks@{Apache Hooks}!A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}}
\index{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK@{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+O\+K(void, error\+\_\+log,(const ap\+\_\+errorlog\+\_\+info $\ast$info, const char $\ast$errstr)) A\+P\+\_\+\+C\+O\+R\+E\+\_\+\+D\+E\+C\+L\+A\+R\+E(void) ap\+\_\+register\+\_\+log\+\_\+hooks(apr\+\_\+pool\+\_\+t $\ast$p)}{AP_DECLARE_HOOK(void, error_log,(const ap_errorlog_info *info, const char *errstr)) AP_CORE_DECLARE(void) ap_register_log_hooks(apr_pool_t *p)}}]{\setlength{\rightskip}{0pt plus 5cm}A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+H\+O\+OK (
\begin{DoxyParamCaption}
\item[{{\bf void}}]{, }
\item[{error\+\_\+log}]{, }
\item[{(const {\bf ap\+\_\+errorlog\+\_\+info} $\ast${\bf info}, const char $\ast$errstr)}]{}
\end{DoxyParamCaption}
)}\hypertarget{group__hooks_gad4d03f3922cbb41275afb5573cb116cc}{}\label{group__hooks_gad4d03f3922cbb41275afb5573cb116cc}
hook method to log error messages


\begin{DoxyParams}{Parameters}
{\em info} & pointer to \hyperlink{structap__errorlog__info}{ap\+\_\+errorlog\+\_\+info} struct which contains all the details \\
\hline
{\em errstr} & the (unformatted) message to log \\
\hline
\end{DoxyParams}
\begin{DoxyWarning}{Warning}
...
\index{Apache Hooks@{Apache Hooks}!ap\+\_\+old\+\_\+write\+\_\+func@{ap\+\_\+old\+\_\+write\+\_\+func}}
\index{ap\+\_\+old\+\_\+write\+\_\+func@{ap\+\_\+old\+\_\+write\+\_\+func}!Apache Hooks@{Apache Hooks}}
\subsubsection[{\texorpdfstring{ap\+\_\+old\+\_\+write\+\_\+func}{ap_old_write_func}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf A\+P\+\_\+\+D\+E\+C\+L\+A\+R\+E\+\_\+\+D\+A\+TA} {\bf ap\+\_\+filter\+\_\+rec\+\_\+t}$\ast$ ap\+\_\+old\+\_\+write\+\_\+func}\hypertarget{group__hooks_ga4808ab9dd70064ff4457755e3f2bd385}{}\label{group__hooks_ga4808ab9dd70064ff4457755e3f2bd385}
This hook allows modules to insert filters for the current error response 
\begin{DoxyParams}{Parameters}
{\em r} & the current request This is an optimization. We keep a record of the filter\+\_\+rec that stores the old\+\_\+write filter, so that we can avoid strcmp\textquotesingle{}s later. \\
\hline
\end{DoxyParams}
