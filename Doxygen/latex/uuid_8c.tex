\hypertarget{uuid_8c}{}\section{/usr/local/src/github/\+Codebase/httpd-\/2.4.29/srclib/apr-\/util/crypto/uuid.c File Reference}
\label{uuid_8c}\index{/usr/local/src/github/\+Codebase/httpd-\/2.\+4.\+29/srclib/apr-\/util/crypto/uuid.\+c@{/usr/local/src/github/\+Codebase/httpd-\/2.\+4.\+29/srclib/apr-\/util/crypto/uuid.\+c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{uuid_8c__incl}
\end{center}
\end{figure}
...
\hyperlink{uuid_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE} (\hyperlink{group__apr__errno_gaa5105fa83cc322f09382292db8b47593}{apr\+\_\+status\+\_\+t})
\end{DoxyCompactItemize}


\subsection{Function Documentation}
\index{uuid.\+c@{uuid.\+c}!A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE}}
\index{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE}!uuid.\+c@{uuid.\+c}}
...
)}\hypertarget{uuid_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}{}\label{uuid_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}
...
\begin{DoxyCode}
96 \{
97     \textcolor{keywordtype}{int} \hyperlink{group__MOD__PROXY_ga38403a0592eb8018a3ad61aef0f7ca2c}{i};
98     \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} *\hyperlink{apr__siphash_8h_a105cb8ad09be3a7d9d15497ce529ccce}{d} = \hyperlink{group__APR__UUID_ga9b3f6ae7758c034f843487ac8ed248c2}{uuid}->\hyperlink{structapr__uuid__t_a8e3dadfe1bd9cbf26478127c4110e0d0}{data};
99 
100     \textcolor{keywordflow}{for} (i = 0; i < 36; ++\hyperlink{group__MOD__PROXY_ga38403a0592eb8018a3ad61aef0f7ca2c}{i}) \{
101     \textcolor{keywordtype}{char} \hyperlink{group__APACHE__CORE__HTTPD_ga7cce37ef8558e46f408cb4d0f555605b}{c} = \hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[\hyperlink{group__MOD__PROXY_ga38403a0592eb8018a3ad61aef0f7ca2c}{i}];
102     \textcolor{keywordflow}{if} (!\hyperlink{group__apr__ctype_ga9d30f3c5d538c21c6d50565cda8654d0}{apr\_isxdigit}(c) &&
103         !(c == \textcolor{charliteral}{'-'} && (i == 8 || i == 13 || i == 18 || i == 23)))
104             \textcolor{comment}{/* ### need a better value */}
105         \textcolor{keywordflow}{return} \hyperlink{group__APR__Error_ga771bf48ab38d93355be8530f6efe4ae9}{APR\_BADARG};
106     \}
107     \textcolor{keywordflow}{if} (\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[36] != \textcolor{charliteral}{'\(\backslash\)0'}) \{
108         \textcolor{comment}{/* ### need a better value */}
109     \textcolor{keywordflow}{return} \hyperlink{group__APR__Error_ga771bf48ab38d93355be8530f6efe4ae9}{APR\_BADARG};
110     \}
111 
112     d[0] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[0]);
113     d[1] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[2]);
114     d[2] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[4]);
115     d[3] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[6]);
116 
117     d[4] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[9]);
118     d[5] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[11]);
119 
120     d[6] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[14]);
121     d[7] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[16]);
122 
123     d[8] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[19]);
124     d[9] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[21]);
125 
126     \textcolor{keywordflow}{for} (i = 6; i--;)
127     d[10 + i] = parse\_hexpair(&\hyperlink{group__APR__UUID_ga43024131bfac4b8508fee85d0a41665d}{uuid\_str}[i*2+24]);
128 
