\hypertarget{sdbm__lock_8c}{}\section{/usr/local/src/github/\+Codebase/httpd-\/2.4.29/srclib/apr-\/util/dbm/sdbm/sdbm\+\_\+lock.c File Reference}
\label{sdbm__lock_8c}\index{/usr/local/src/github/\+Codebase/httpd-\/2.\+4.\+29/srclib/apr-\/util/dbm/sdbm/sdbm\+\_\+lock.\+c@{/usr/local/src/github/\+Codebase/httpd-\/2.\+4.\+29/srclib/apr-\/util/dbm/sdbm/sdbm\+\_\+lock.\+c}}
...
Include dependency graph for sdbm\+\_\+lock.\+c\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{sdbm__lock_8c__incl}
\end{center}
\end{figure}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\hyperlink{sdbm__lock_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE} (\hyperlink{group__apr__errno_gaa5105fa83cc322f09382292db8b47593}{apr\+\_\+status\+\_\+t})
\end{DoxyCompactItemize}


\subsection{Function Documentation}
\index{sdbm\+\_\+lock.\+c@{sdbm\+\_\+lock.\+c}!A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE}}
\index{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE@{A\+P\+U\+\_\+\+D\+E\+C\+L\+A\+RE}!sdbm\+\_\+lock.\+c@{sdbm\+\_\+lock.\+c}}
...
)}\hypertarget{sdbm__lock_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}{}\label{sdbm__lock_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e}
...
\begin{DoxyCode}
26 \{
27     \hyperlink{group__apr__errno_gaa5105fa83cc322f09382292db8b47593}{apr\_status\_t} \hyperlink{group__APACHE__CORE__HTTPD_ga6e27f49150e9a14580fb313cc2777e00}{status};
28     \textcolor{keywordtype}{int} lock\_type = \hyperlink{group__APACHE__CORE__HTTPD_gaafc7089562892428c4fcae486f171f5a}{type} & \hyperlink{group__apr__file__lock__types_ga40777e364fb20bb9a9ee57e74b19c13d}{APR\_FLOCK\_TYPEMASK};
29 
30     \textcolor{keywordflow}{if} (!(lock\_type == \hyperlink{group__apr__file__lock__types_gaba177fe81cd70b389753ad2096b2ce7c}{APR\_FLOCK\_SHARED} || lock\_type == 
      \hyperlink{group__apr__file__lock__types_gafbf0caa093b99bdf11e25360b9099852}{APR\_FLOCK\_EXCLUSIVE}))
31         \textcolor{keywordflow}{return} \hyperlink{group__APR__Error_gae3ffc41994444e71ce522c036ca1d9a4}{APR\_EINVAL};
32 
33     \textcolor{keywordflow}{if} (db->flags & \hyperlink{sdbm__private_8h_afa25ea6f9f84ea0f92c94e53bd43c208}{SDBM\_EXCLUSIVE\_LOCK}) \{
34         ++db->lckcnt;
35         \textcolor{keywordflow}{return} \hyperlink{group__apr__errno_ga9ee311b7bf1c691dc521d721339ee2a6}{APR\_SUCCESS};
36     \}
37     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (db->flags & \hyperlink{sdbm__private_8h_a2f57981ec7a7aace7e62f6cb42ee5029}{SDBM\_SHARED\_LOCK}) \{
38         \textcolor{comment}{/*}
39 \textcolor{comment}{         * Cannot promote a shared lock to an exlusive lock}
40 \textcolor{comment}{         * in a cross-platform compatibile manner.}
41 \textcolor{comment}{         */}
42         \textcolor{keywordflow}{if} (\hyperlink{group__APACHE__CORE__HTTPD_gaafc7089562892428c4fcae486f171f5a}{type} == \hyperlink{group__apr__file__lock__types_gafbf0caa093b99bdf11e25360b9099852}{APR\_FLOCK\_EXCLUSIVE})
43             \textcolor{keywordflow}{return} \hyperlink{group__APR__Error_gae3ffc41994444e71ce522c036ca1d9a4}{APR\_EINVAL};
44         ++db->lckcnt;
45         \textcolor{keywordflow}{return} \hyperlink{group__apr__errno_ga9ee311b7bf1c691dc521d721339ee2a6}{APR\_SUCCESS};
46     \}
47     \textcolor{comment}{/*}
48 \textcolor{comment}{     * zero size: either a fresh database, or one with a single,}
49 \textcolor{comment}{     * unsplit data page: dirpage is all zeros.}
50 \textcolor{comment}{     */}
51     \textcolor{keywordflow}{if} ((status = \hyperlink{netware_2flock_8c_a2d337e66c1fa0cd433164079bf542484}{apr\_file\_lock}(db->dirf, \hyperlink{group__APACHE__CORE__HTTPD_gaafc7089562892428c4fcae486f171f5a}{type})) == \hyperlink{group__apr__errno_ga9ee311b7bf1c691dc521d721339ee2a6}{APR\_SUCCESS}) 
52     \{
53         \hyperlink{structapr__finfo__t}{apr\_finfo\_t} finfo;
54         \textcolor{keywordflow}{if} ((status = apr\_file\_info\_get(&finfo, \hyperlink{group__apr__file__stat_gadf72493da450c0b1e3d279e98a973120}{APR\_FINFO\_SIZE}, db->dirf))
55                 != \hyperlink{group__apr__errno_ga9ee311b7bf1c691dc521d721339ee2a6}{APR\_SUCCESS}) \{
56             (\hyperlink{group__MOD__ISAPI_gacd6cdbf73df3d9eed42fa493d9b621a6}{void}) \hyperlink{netware_2flock_8c_a3a255996fb439b6d66ed7cd65319525b}{apr\_file\_unlock}(db->dirf);
57             \textcolor{keywordflow}{return} \hyperlink{group__APACHE__CORE__HTTPD_ga6e27f49150e9a14580fb313cc2777e00}{status};
58         \}
59 
60         \hyperlink{sdbm__private_8h_ab1bc6e7d1c500555d892a6cd961035a7}{SDBM\_INVALIDATE\_CACHE}(db, finfo);
61 
62         ++db->lckcnt;
63         \textcolor{keywordflow}{if} (\hyperlink{group__APACHE__CORE__HTTPD_gaafc7089562892428c4fcae486f171f5a}{type} == \hyperlink{group__apr__file__lock__types_gaba177fe81cd70b389753ad2096b2ce7c}{APR\_FLOCK\_SHARED})
64             db->flags |= \hyperlink{sdbm__private_8h_a2f57981ec7a7aace7e62f6cb42ee5029}{SDBM\_SHARED\_LOCK};
65         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\hyperlink{group__APACHE__CORE__HTTPD_gaafc7089562892428c4fcae486f171f5a}{type} == \hyperlink{group__apr__file__lock__types_gafbf0caa093b99bdf11e25360b9099852}{APR\_FLOCK\_EXCLUSIVE})
66             db->flags |= \hyperlink{sdbm__private_8h_afa25ea6f9f84ea0f92c94e53bd43c208}{SDBM\_EXCLUSIVE\_LOCK};
67     \}
68     \textcolor{keywordflow}{return} \hyperlink{group__APACHE__CORE__HTTPD_ga6e27f49150e9a14580fb313cc2777e00}{status};
69 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=289pt]{sdbm__lock_8c_aac2a5ebd110b5bf5a9f6733dac29fc3e_cgraph}
\end{center}
\end{figure}
